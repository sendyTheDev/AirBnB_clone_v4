...
## Environment
This project is interpreted/tested on Ubuntu 20.00 LTS using python3 (version 3.4.3)

## Installation
* Clone this repository: `git clone "https://github.com/sendyTheDev/AirBnB_clone.git"`
